<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminmanagecourse.aspx.cs" Inherits="Orgiz.adminmanagecourse" %>
                ...
                <a class="nav-link" href="adminmanagecourse.aspx">
                  ...
                  Manage Student Courses
                           ...
                           <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <div class="col-md-5">
                                        <label>Student Name</label>
                                            <div class="form-group">
                                            <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Mughees..."></asp:TextBox>
                                            </div>
                                    </div>
                             ...
                             <div class="col-md-5">
                                    <label>Course ID</label>
                                        <div class="form-group">
                                             <div class="form-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="CS202..."></asp:TextBox>
                             ...
                             <div class="col-md-8">
                                    <label>Course Name</label>
                                            ...
                                            <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Database..."></asp:TextBox>
                                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrgizzConnectionString %>" SelectCommand="SELECT * FROM [StudentCourse] ORDER BY [StudentID]"></asp:SqlDataSource>
                            <div class="col">
                                <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="StudentID,CourseID" DataSourceID="SqlDataSource1">
                                    <Columns>
