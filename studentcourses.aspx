<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="studentcourses.aspx.cs" Inherits="Orgiz.studentcourses" %>
              ...
              <li class="nav-item">
                <a class="nav-link active" href="studentcourses.aspx">
                  ...
                  Courses <span class="sr-only">(current)</span>
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Your Current Courses</h5>
                             <div class = "row">
                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrgizzConnectionString %>" SelectCommand="SELECT StudentCourse.CourseID, Courses.CourseName FROM StudentCourse INNER JOIN Student ON StudentCourse.StudentID = Student.StudentID INNER JOIN Courses ON StudentCourse.CourseID = Courses.CourseID"></asp:SqlDataSource>
                                  <div class = "col">
