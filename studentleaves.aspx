<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="studentleaves.aspx.cs" Inherits="Orgiz.studentleaves" %>
              ...
              <li class="nav-item">
                ...
                <a class="nav-link active" href="studentleaves.aspx">
                  ...
                  Student Leaves <span class="sr-only">(current)</span>
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Student Leave Requests</h5>
                             <div class = "row">
                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrgizzConnectionString %>" SelectCommand="SELECT [message] FROM [Leave]"></asp:SqlDataSource>
                                  <div class = "col">
