<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="teacherrating.aspx.cs" Inherits="Orgiz.teacherrating" %>
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrgizzConnectionString %>" SelectCommand="SELECT TeacherCourse.CourseID, StudentCourse.StudentID, Student.FName, StudentCourse.Marks FROM StudentCourse INNER JOIN TeacherCourse ON StudentCourse.CourseID = TeacherCourse.CourseID INNER JOIN Student ON StudentCourse.StudentID = Student.StudentID"></asp:SqlDataSource>
                            <div class="col">
