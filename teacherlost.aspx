<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="teacherlost.aspx.cs" Inherits="Orgiz.teacherlost" %>
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="teacherlost.aspx">
                  ...
                  <div class="col-md-5">
                                        <label>Input your lost Item with your ID mentioned in it!</label>
