<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="studentprogress.aspx.cs" Inherits="Orgiz.studentprogress" %>
                ...
                <a class="nav-link" href="studentprogress.aspx">
                  ...
                  Progress
                   ...
                   <div class="card text-center">
                       ...
                       <div class="card-body">
                        <h5 class="card-title">Progress in Current Courses</h5>
                             <div class = "row">
                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrgizzConnectionString %>" SelectCommand="SELECT StudentCourse.CourseID, Courses.CourseName, StudentCourse.Marks FROM StudentCourse INNER JOIN Courses ON StudentCourse.CourseID = Courses.CourseID"></asp:SqlDataSource>
                                  <div class = "col">
