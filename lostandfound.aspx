<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="lostandfound.aspx.cs" Inherits="Orgiz.lostandfound" %>
                ...
                <a class="nav-link active" href="lostandfound.aspx">
                  ...
                  Lost and Found <span class="sr-only">(current)</span>
                        ...
                        <h5 class="card-title">Lost and Found</h5>
                             <div class = "row">
                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrgizzConnectionString %>" SelectCommand="SELECT [message] FROM [LostandFound]"></asp:SqlDataSource>
                                  <div class = "col">
