<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="teacherleaves.aspx.cs" Inherits="Orgiz.teacherleaves" %>
              ...
              <li class="nav-item">
                ...
                <a class="nav-link active" href="teacherleaves.aspx">
                  ...
                  Teacher Leaves <span class="sr-only">(current)</span>
                     ...
                     <div class="card-body">
                        <h5 class="card-title">Teacher Leave Requests</h5>
                             <div class = "row">
                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrgizzConnectionString %>" SelectCommand="SELECT [message] FROM [teacherleave]"></asp:SqlDataSource>
                                  <div class = "col">
                                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="message" DataSourceID="SqlDataSource1" >
                                            <Columns>
