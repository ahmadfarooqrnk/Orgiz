<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="studentattendance.aspx.cs" Inherits="Orgiz.studentattendance" %>
                ...
                <a class="nav-link" href="studentattendance.aspx">
                  ...
                  Attendance
                   ...
                   <div class="card text-center">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Your Current Attendance</h5>
                             <div class = "row">
                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrgizzConnectionString %>" SelectCommand="SELECT Attendance.StudentID, Attendance.CourseID, Attendance.LectureNo, Attendance.Status FROM Attendance INNER JOIN StudentCourse ON Attendance.StudentID = StudentCourse.StudentID"></asp:SqlDataSource>
                                  <div class = "col">
                                         <asp:GridView class="table table-striped table-bordered" ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="CourseID,LectureNo" DataSourceID="SqlDataSource1">
                                             <Columns>
                                                 <asp:BoundField DataField="StudentID" HeaderText="StudentID" SortExpression="StudentID" />
                                                 <asp:BoundField DataField="CourseID" HeaderText="CourseID" ReadOnly="True" SortExpression="CourseID" />
                                                 <asp:BoundField DataField="LectureNo" HeaderText="LectureNo" ReadOnly="True" SortExpression="LectureNo" />
