<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="teachergrades.aspx.cs" Inherits="Orgiz.teachergrades" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label>Marks</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Out of 100"></asp:TextBox>
                             ...
                             <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="FSC-01..."></asp:TextBox>
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrgizzConnectionString %>" SelectCommand="SELECT StudentCourse.CourseID, StudentCourse.StudentID, StudentCourse.Marks FROM StudentCourse INNER JOIN TeacherCourse ON StudentCourse.CourseID = TeacherCourse.CourseID" ></asp:SqlDataSource>
                            <div class="col">
                                <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="CourseID,StudentID">
                                    <Columns>
